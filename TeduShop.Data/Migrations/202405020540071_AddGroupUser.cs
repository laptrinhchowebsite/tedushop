    ...
    public partial class AddGroupUser : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.ApllicationGroups", t => t.GroupId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ApplicationUserGroups", "GroupId", "dbo.ApllicationGroups");
            DropForeignKey("dbo.ApplicationRoleGroups", "RoleId", "dbo.ApplicationRoles");
            DropForeignKey("dbo.ApplicationRoleGroups", "GroupId", "dbo.ApllicationGroups");
            ...
            DropTable("dbo.ApllicationGroups");
        }
    }
}
